(define (problem n5-b6-c4)
    ...
    (:hidden
        (ball-pos b1 p3 p1) (ball-color b1 c1)
        (ball-pos b2 p1 p1) (ball-color b2 c1)
        (ball-pos b3 p5 p5) (ball-color b3 c1)
        (ball-pos b4 p1 p2) (ball-color b4 c1)
        (ball-pos b5 p2 p1) (ball-color b5 c2)
        (ball-pos b6 p2 p2) (ball-color b6 c4)
