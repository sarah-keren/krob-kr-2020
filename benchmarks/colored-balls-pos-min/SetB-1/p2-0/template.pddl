(define (problem n5-b6-c4)
    ...
    (:hidden
        (ball-pos b1 p3 p4) (ball-color b1 c1)
        (ball-pos b2 p2 p1) (ball-color b2 c1)
        (ball-pos b3 p4 p1) (ball-color b3 c1)
        (ball-pos b4 p5 p3) (ball-color b4 c1)
        (ball-pos b5 p4 p4) (ball-color b5 c4)
