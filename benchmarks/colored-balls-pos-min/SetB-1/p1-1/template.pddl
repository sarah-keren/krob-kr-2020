(define (problem n5-b5-c4)
    ...
    (:hidden
        (ball-pos b1 p1 p4) (ball-color b1 c2)
        (ball-pos b2 p1 p4) (ball-color b2 c3)
        (ball-pos b3 p4 p4) (ball-color b3 c3)
        (ball-pos b4 p1 p4) (ball-color b4 c4)
        (ball-pos b5 p5 p5) (ball-color b5 c4)
