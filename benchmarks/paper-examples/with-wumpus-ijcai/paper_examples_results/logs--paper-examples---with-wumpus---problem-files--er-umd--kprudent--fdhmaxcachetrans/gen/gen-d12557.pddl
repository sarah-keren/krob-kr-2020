(define (domain full-wumpus)
    ...
    (:action sensor-sensor-for-stench_p_4_2-obs0-ver0
        :effect (and (when (and (not (K_not_stench_p_4_2)) (not (K_stench_p_4_2)) (K_at_p_4_2)) (K_stench_p_4_2))(increase (total-cost) 1)
))
    (:action sensor-sensor-for-stench_p_4_2-obs0-ver1
        :effect (and (when (and (not (K_not_stench_p_4_2)) (not (K_stench_p_4_2)) (K_at_p_4_2)) (K_not_stench_p_4_2))(increase (total-cost) 1)
))
    ...
    (:action sensor-sensor-for-stench_p_3_3-obs0-ver0
        :effect (and (when (and (not (K_not_stench_p_3_3)) (not (K_stench_p_3_3)) (K_at_p_3_3)) (K_stench_p_3_3))(increase (total-cost) 1)
))
    (:action sensor-sensor-for-stench_p_3_3-obs0-ver1
        :effect (and (when (and (not (K_not_stench_p_3_3)) (not (K_stench_p_3_3)) (K_at_p_3_3)) (K_not_stench_p_3_3))(increase (total-cost) 1)
))
    (:action sensor-sensor-for-stench_p_3_2-obs0-ver0
        :effect (and (when (and (not (K_not_stench_p_3_2)) (not (K_stench_p_3_2)) (K_at_p_3_2)) (K_stench_p_3_2))(increase (total-cost) 1)
))
    (:action sensor-sensor-for-stench_p_3_2-obs0-ver1
        :effect (and (when (and (not (K_not_stench_p_3_2)) (not (K_stench_p_3_2)) (K_at_p_3_2)) (K_not_stench_p_3_2))(increase (total-cost) 1)
))
    (:action sensor-sensor-for-stench_p_3_1-obs0-ver0
        :effect (and (when (and (not (K_not_stench_p_3_1)) (not (K_stench_p_3_1)) (K_at_p_3_1)) (K_stench_p_3_1))(increase (total-cost) 1)
))
    (:action sensor-sensor-for-stench_p_3_1-obs0-ver1
        :effect (and (when (and (not (K_not_stench_p_3_1)) (not (K_stench_p_3_1)) (K_at_p_3_1)) (K_not_stench_p_3_1))(increase (total-cost) 1)
))
    ...
    (:action sensor-sensor-for-stench_p_2_2-obs0-ver0
        :effect (and (when (and (not (K_not_stench_p_2_2)) (not (K_stench_p_2_2)) (K_at_p_2_2)) (K_stench_p_2_2))(increase (total-cost) 1)
))
    (:action sensor-sensor-for-stench_p_2_2-obs0-ver1
        :effect (and (when (and (not (K_not_stench_p_2_2)) (not (K_stench_p_2_2)) (K_at_p_2_2)) (K_not_stench_p_2_2))(increase (total-cost) 1)
))
    ...
    (:action sensor-sensor-for-breeze_p_3_2-obs0-ver0
        :effect (and (when (and (not (K_not_breeze_p_3_2)) (not (K_breeze_p_3_2)) (K_at_p_3_2)) (K_breeze_p_3_2))(increase (total-cost) 1)
))
    (:action sensor-sensor-for-breeze_p_3_2-obs0-ver1
        :effect (and (when (and (not (K_not_breeze_p_3_2)) (not (K_breeze_p_3_2)) (K_at_p_3_2)) (K_not_breeze_p_3_2))(increase (total-cost) 1)
))
