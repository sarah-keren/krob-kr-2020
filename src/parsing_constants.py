...
STRUCTURE = ['Designing domain', 'pruning', 'heuristic', 'budget']
...
TOTAL_KEYWORD = 'Total'
TOTAL_KEYLIST = ['Designing domain', 'pruning', 'heuristic']
...
FLAGS = {'ex_terminated': 'False', 'wcd_greater_than_0': 'True'}
FLAG_LABELS = [' for completed', ' for wcd > 0']
