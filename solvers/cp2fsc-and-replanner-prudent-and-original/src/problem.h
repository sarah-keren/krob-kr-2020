...
class Instance {
  ...
  protected:
    ...
    std::string compilation_ = "unilitialized";
  ...
  public:
    ...
    struct Action {
        ...
        void write(std::ostream &os, int indent, const Instance &instance, const std::string compilation) const;
    };
    ...
    virtual void set_compilation(std::string compilation){
