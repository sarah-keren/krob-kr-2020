...
def ground(problem,checkRelevance=True, static_analysis = False):
    """
    ...
    # Ground actions    
    operators = _ground_actions(actions, type_map, statics, init,static_analysis)
    if verbose_logging:
...
def _ground_actions(actions, type_map, statics, init,static_analysis):
    """
    ...
    op_lists = [_ground_action(action, type_map, statics, init, static_analysis)
...
def _ground_action(action, type_map, statics, init, static_analysis = False):
    """
